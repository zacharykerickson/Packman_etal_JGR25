...
- Figures_final.ipynb - inputs RFROM .nc files, stdev_T.nc, and lagged_correlation_analysis_150m_final.nc to reproduce the 6 figures in the paper (and 4 supplemental figures), which are saved as .png files
...
- Figure_correlation_multipledepths_supplement.png - Figure S2 of paper
- Figure_lagged_correlation_omit_supplement_final.png - Figure S3 of paper
- Figure_correlation_multipledecades_supplement.png - Figure S4 of paper
